    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-background/80 backdrop-blur-sm">
      <div className="bg-surface rounded-t-2xl sm:rounded-2xl shadow-2xl w-full sm:max-w-sm overflow-hidden transform transition-all scale-100 border border-border">
        ...
        <div className="bg-surface-highlight px-4 sm:px-6 py-3 sm:py-4 flex gap-2 sm:gap-3 justify-center border-t border-border">
          <button
            onClick={onClose}
            className="flex-1 px-3 sm:px-4 py-2 bg-surface border border-border rounded-lg text-text-main text-xs sm:text-sm font-semibold hover:bg-surface-highlight transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 px-3 sm:px-4 py-2 bg-red-600 text-white rounded-lg text-xs sm:text-sm font-semibold hover:bg-red-700 shadow-md shadow-red-900/30 transition-colors"
          >
            Delete
          </button>
        </div>
